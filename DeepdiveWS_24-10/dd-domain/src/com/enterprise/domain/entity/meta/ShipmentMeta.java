 ...
 */
@Entity
@DiscriminatorValue("com.enterprise.domain.entity.meta.ShipmentMeta")
public class ShipmentMeta extends Meta implements IMeta, Serializable {
	
	private static final long serialVersionUID = 518259320377795338L;
	private static final String ENTITY_CLASS = "com.enterprise.domain.entity.Shipment";
	...
	@Override
	public IMeta clone() {
		ShipmentMeta newInstance = new ShipmentMeta();
