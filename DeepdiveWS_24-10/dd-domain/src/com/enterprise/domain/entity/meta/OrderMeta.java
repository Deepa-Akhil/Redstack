...
@Entity
@DiscriminatorValue("com.enterprise.domain.entity.meta.OrderMeta")
public class OrderMeta  extends Meta implements IMeta, Serializable{

	private static final long serialVersionUID = -525983580310677299L;

	private static final String ENTITY_CLASS = "com.enterprise.domain.entity.OrderMeta";
	...
	@Override
	public IMeta clone() {
		OrderMeta newInstance = new OrderMeta();
